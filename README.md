...
`public/sample/wonju-mammut-35k.gpx`는 공개 가능한 레이스 코스 샘플로, 앱의 레이스 전 코스 분석 기능을 시연하기 위한 데모 데이터입니다.
샘플 GPX에는 실제 코스 좌표와 코스명이 포함되어 있으므로, 재사용 시 원본 코스/이벤트 맥락을 확인하세요.
